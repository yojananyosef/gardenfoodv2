...
- [ ] 1.3 Exponer tipos y helpers de los nuevos campos en `lib/supabase/types` (o equivalentes del proyecto); verificar con `pnpm tsc --noEmit`
...
- [ ] 4.4 Respeto del selector global de huerto (R5) en los tres bloques, persistente al alternar modo; verificar cambiando de huerto en fixture multi-huerto
...
- [ ] 5.5 Asistente «¿Qué árbol tienes?» (tarjetas de fruta + buscador) que crea cultivo y árboles vía actions del huerto, respeta el límite del plan y aterriza en la ficha; verificar con fixture del plan free
...
- [ ] 7.1 Tests vitest de actions nuevas (setHuertoModo, alta desde asistente, Lo eché) y del default de modo; `pnpm test` verde con la suite completa
...
- [ ] 7.3 `pnpm lint && pnpm tsc --noEmit` + validación `openspec validate huerto-modos-guiado-modular`
