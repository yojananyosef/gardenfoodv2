...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-screen flex-col bg-background lg:grid lg:h-screen lg:grid-cols-[1.05fr_0.95fr] lg:overflow-hidden">
      {/* Left — editorial (solo desktop). Columna con scroll interno si el
          viewport es bajo: la página nunca scrollea a nivel body. */}
      ...
      {/* Right — form. Altura contenida en desktop, scroll interno si hace falta. */}
