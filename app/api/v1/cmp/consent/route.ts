...
export async function POST(request: Request) {
  ...
  const row = {
    ...
    consent_personalized_ads: purposes.personalizedAds,
    consent_precise_geo: purposes.preciseGeo,
    consent_third_party_sharing: purposes.thirdPartySharing,
    consent_device_linking: purposes.deviceLinking,
  ...
  const response = NextResponse.json({
    consent: {
      ...
      personalizedAds: purposes.personalizedAds,
      preciseGeo: purposes.preciseGeo,
      thirdPartySharing: purposes.thirdPartySharing,
      deviceLinking: purposes.deviceLinking,
